...
```
app/Models/          Account, User, Category, Company, BankAccount, BalanceAnchor, PaymentCard, CreditCardInvoice,
                     InstallmentPlan, RecurringBill, Transaction, SupportTicket, SupportTicketAttachment,
                     SupportTicketReply
app/Services/        BalanceService, ViewContext, OwnershipResolver, CreditCardInvoiceService, CreditCardPaymentService,
...
resources/js/Pages/  Landing, Dashboard, Transactions, Installments, RecurringBills,
                     BankAccounts, PaymentCards, Companies, Categories, Members, Reports, SupportTickets,
...
2. Preferir trait/scope `BelongsToAccount` + Policies em vez de filtros ad hoc. Listagens usam `forViewContext` / `ViewContext`.
3. Owner gerencia categorias, membros e pode lançar/ver saldo de qualquer membro; dependent edita/exclui só o próprio e informa o **próprio** caixa.
